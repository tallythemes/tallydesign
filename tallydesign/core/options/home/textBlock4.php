<?php
$home_textBlock_prefix = 'home_textBlock4_';
...
$custom_settings['settings'][] = array(
	'id'          => $home_textBlock_prefix.'enable',
	'label'       => __('Enable TextBlock 4 Section', 'tally_taxdomain'),
	'desc'        => '',
	'std'         => tally_option_std($home_textBlock_prefix.'enable'),
	'type'        => 'on_off',
	'section'     => 'home',
	'rows'        => '5',
	'post_type'   => '',
...
$custom_settings['settings'][] = array(
	'id'          => $home_textBlock_prefix.'content',
	'label'       => __('Content', 'tally_taxdomain'),
	'desc'        => '',
	'std'         => tally_option_std($home_textBlock_prefix.'description'),
	'type'        => 'textarea',
	'section'     => 'home',
	'rows'        => '5',
	'post_type'   => '',
...
$custom_settings['settings'][] = array(
	...
	'desc'        => '',
	'std'         => tally_option_std($home_textBlock_prefix.'button_link'),
	'type'        => 'text',
	'section'     => 'home',
	'rows'        => '5',
	'post_type'   => '',
...
$custom_settings['settings'][] = array(
	'id'          => $home_textBlock_prefix.'button_text',
	'label'       => __('Button Text', 'tally_taxdomain'),
	'desc'        => '',
	'std'         => tally_option_std($home_textBlock_prefix.'button_text'),
	'type'        => 'text',
	'section'     => 'home',
	'rows'        => '5',
	'post_type'   => '',
...
$custom_settings['settings'][] = array(
	'id'          => $home_textBlock_prefix.'padding',
...
$custom_settings['settings'][] = array(
	'id'          => $home_textBlock_prefix.'heading_color',
	...
	'std'         => tally_option_std($home_textBlock_prefix.'heading_color'),
	'type'        => 'colorpicker',
	'section'     => 'home',
	'rows'        => '5',
	'post_type'   => '',
...
$custom_settings['settings'][] = array(
	'id'          => $home_textBlock_prefix.'border_color',
	'label'       => __('Border Color', 'tally_taxdomain'),
	'desc'        => __('Border color of the section..', 'tally_taxdomain'),
	'std'         => tally_option_std($home_textBlock_prefix.'border_color'),
	'type'        => 'colorpicker',
	'section'     => 'home',
	'rows'        => '5',
	'post_type'   => '',
